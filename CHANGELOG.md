...
### v3.6.2 [![23.02.2026](https://img.shields.io/date/1771856854)](https://github.com/d8corp/watch-state/tree/v3.6.2)
...
### v3.4.4 [![25.08.2022](https://img.shields.io/date/1661421298)](https://github.com/d8corp/watch-state/tree/v3.4.4)
...
- fixed deep bugs
- added `globalEvent`
- unfortunately, the performance has decreased, but the current version is strong stable and still, this is one of the
  fastest solutions.
