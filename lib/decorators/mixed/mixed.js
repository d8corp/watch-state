...
var classes_Mixed_Mixed = require('../../classes/Mixed/Mixed.js');

function mixed(target, propertyKey, descriptor) {
    ...
    return {
        get: function () {
            ...
            if (!(propertyKey in values)) {
                utils_unwatch_unwatch['default'](function () { return values[propertyKey] = new classes_Mixed_Mixed['default'](originalGet.bind(_this)); });
            }
